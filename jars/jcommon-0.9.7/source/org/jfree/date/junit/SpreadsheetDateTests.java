...
public class SpreadsheetDateTests extends TestCase {
    ...
    public void test12Nov2001GetDayOfWeek() {
        final SerialDate nov12Y2001 = new SpreadsheetDate(12, SerialDate.NOVEMBER, 2001);
    ...
    public void test28Feb1900ToSerial() {
        final SpreadsheetDate d = new SpreadsheetDate(28, SerialDate.FEBRUARY, 1900);
    ...
    public void test01Mar1900ToSerial() {
        final SpreadsheetDate d = new SpreadsheetDate(1, SerialDate.MARCH, 1900);
    ...
    public void test31Dec1999ToSerial() {
        final SpreadsheetDate d = new SpreadsheetDate(31, SerialDate.DECEMBER, 1999);
