...
public abstract class TextUtilities {
     ...
     * 
     * @return The text bounds (<code>null</code> if the <code>text</code> argument is 
     *         <code>null</code>).
     */
     ...
     * @param textBounds  the text bounds (if not <code>null</code>, this object will be updated
    ...
    public static Shape calculateRotatedStringBounds(String text,
        ...
        Shape result = calculateRotatedStringBounds(
            text, g2, x + textAdj[0], y + textAdj[1],
            angle, x + textAdj[0] + rotateAdj[0], y + textAdj[1] + rotateAdj[1]
        );
        return result;
     ...
     * 
     * @return The bounds (<code>null</code> if <code>text</code> is </code>null</code> 
     *         or has zero length).
     */
    public static Shape calculateRotatedStringBounds(String text,
                                                     Graphics2D g2,
