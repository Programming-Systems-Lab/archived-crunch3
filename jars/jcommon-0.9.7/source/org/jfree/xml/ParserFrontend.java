...
public class ParserFrontend {
     ...
     */
    protected ParserFrontend(final Parser parser) {
        if (parser == null) {
     ...
     */
    public void setDefaultHandler(final Parser handler) {
        if (handler == null) {
            throw new NullPointerException();
        }
     ...
     * @return the report handler.
     */
    protected Parser createDefaultHandler(final URL contentBase) {
        final Parser handler = getDefaultHandler().getInstance();
        if (contentBase != null) {
    ...
    protected Object parse(final InputSource input, final URL contentBase)
        ...
        try {
            ...
            final Parser handler = createDefaultHandler(contentBase);
     ...
     */
    protected void configureReader(final XMLReader reader, final Parser handler) {
        try {
            reader.setProperty
